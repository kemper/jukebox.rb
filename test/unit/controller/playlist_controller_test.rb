...
class PlaylistControllerTest < Test::Unit::TestCase
  ...
  should "add_random creates a random PlaylistEntry and redirects to playlist_url" do
  ...
  should "add_for creates a random PlaylistEntry for the user and redirects to playlist_url" do
    controller = PlaylistController.new
  ...
  should "toggle_continuous_play toggles continuous play on PlayerStatus and renders nothing" do
  ...
  should "skip requests a skip on the current playlist entry and passes the remote ip" do
    controller = PlaylistController.new
