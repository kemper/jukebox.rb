ActionController::Routing::Routes.draw do |map|
  ...
  map.playlist_like '/playlist/like/:id', :controller => 'playlist', :action => 'like'
  map.playlist_dislike '/playlist/dislike/:id', :controller => 'playlist', :action => 'dislike'
  map.playlist_hate '/playlist/hate/:id', :controller => 'playlist', :action => 'hate'
